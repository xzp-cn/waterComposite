...
namespace FSpace
{
    ...
    ///-------------------------------------------------------------------------------------------------
    public class ScreenCamera3D : MonoBehaviour
    {
        /// <summary>
        /// 中央相机，场景中物体命名为"cam_c"
        /// </summary>
        ...
        /// 固定相机没必要实时更新相机的投影矩阵
        /// </summary>
        public bool isAdjustCameraPos = false;
        void OnEnable()
        {
            if(!isAdjustCameraPos)
        ...
        void findCamera()
        {
            ...
            for (int i = 0; i < cams.Length; i++)
            {
                ...
                //设置它的父节点
                cams[i].transform.SetParent(transform);
            ...
            if (cam_c == null)
            {
                ...
                cam_c.transform.SetParent(transform);
            ...
            if (cam_l == null)
            {
                ...
                cam_l.transform.SetParent(transform);
        ...
        void Update()
        {
            ...
            if(mrsys == null) mrsys = FindObjectOfType<MRSystem>();
            if (null != mrsys)
            {
