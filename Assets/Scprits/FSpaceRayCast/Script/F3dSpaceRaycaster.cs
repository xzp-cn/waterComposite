...
{
    public class F3dSpaceRaycaster : GraphicRaycaster, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            if (eventData.IsF3dSpacePointer())
            {
                ...
                F3dSpaceInputModule inputModule = EventSystem.current.currentInputModule as F3dSpaceInputModule;
