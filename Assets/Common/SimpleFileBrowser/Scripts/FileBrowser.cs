	...
	public class FileBrowser : MonoBehaviour, IListViewAdapter
	{
        ...
        private static FileBrowser Instance
		{
			get
			{
                if ( m_instance == null )
				{
                    m_instance = Instantiate(Resources.Load<GameObject>("SimpleFileBrowser/SimpleFileBrowser")).GetComponent<FileBrowser>();
                    DontDestroyOnLoad(m_instance.gameObject);
                    //m_instance.gameObject.SetActive( false );
                    //从ECS的Game池里取
                    //var entity = ECSHelper.GetUIModule("SimpleFileBrowser");
                    //m_instance = entity.u3DObj.obj.GetComponent<FileBrowser>();
                }
        ...
        //public Color normalFileColor = new Color32(82,82,82,255);
